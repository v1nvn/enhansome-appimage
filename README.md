...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,596 | 🐛 186 | 🌐 C++ | 📅 2025-12-15 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,523 | 🐛 154 | 🌐 Python | 📅 2026-02-02 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,097 | 🐛 131 | 🌐 Go | 📅 2025-12-13 - Optional daemon that integrates AppImages into the system (experimental).
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,019 | 🐛 509 | 🌐 C | 📅 2026-02-07 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 265 | 🐛 0 | 🌐 Shell | 📅 2026-02-08 - AppImage Manager that works like APT or Pacman.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,255 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Converts AppDirs into AppImages.
...
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,097 | 🐛 131 | 🌐 Go | 📅 2025-12-13 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,441 | 🐛 112 | 🌐 TypeScript | 📅 2026-02-08 - Supports AppImage as an output format.
...
* [pkg2appimage](https://github.com/AppImage/pkg2appimage) ⭐ 760 | 🐛 179 | 🌐 Shell | 📅 2025-07-21 - Converts from deb, zip, tar.gz and other formats to AppImage using YAML recipes.
...
* [flatpak2appdir](https://github.com/sudo-give-me-coffee/flatpak2appdir) ⭐ 28 | 🐛 7 | 🌐 Shell | 📅 2020-05-11 - Turn Flatpak into AppDir which in turn can be turned into AppImage.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,255 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,255 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Comparison to other packaging systems.

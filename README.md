...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,873 | 🐛 193 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,745 | 🐛 166 | 🌐 Python | 📅 2026-04-12 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,279 | 🐛 532 | 🌐 C | 📅 2026-04-06 - Optional sandbox with support for AppImage built in.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,308 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Converts AppDirs into AppImages.
...
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 35 | 🐛 12 | 🌐 Starlark | 📅 2026-04-13 - Bazel rules to package any lang\_binary target as AppImage.
...
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 757 | 🐛 99 | 🌐 C++ | 📅 2026-04-12 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,520 | 🐛 103 | 🌐 TypeScript | 📅 2026-04-12 - Supports AppImage as an output format.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,308 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,308 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Comparison to other packaging systems.

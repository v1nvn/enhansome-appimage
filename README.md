...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,916 | 🐛 195 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,792 | 🐛 170 | 🌐 Python | 📅 2026-04-19 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,321 | 🐛 537 | 🌐 C | 📅 2026-04-23 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 303 | 🐛 0 | 🌐 Shell | 📅 2026-04-19 - AppImage Manager that works like APT or Pacman.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,534 | 🐛 103 | 🌐 TypeScript | 📅 2026-04-22 - Supports AppImage as an output format.

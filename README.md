...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,895 | 🐛 193 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,769 | 🐛 168 | 🌐 Python | 📅 2026-04-18 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,298 | 🐛 535 | 🌐 C | 📅 2026-04-17 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 300 | 🐛 0 | 🌐 Shell | 📅 2026-04-19 - AppImage Manager that works like APT or Pacman.
...
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 757 | 🐛 100 | 🌐 C++ | 📅 2026-04-12 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,523 | 🐛 105 | 🌐 TypeScript | 📅 2026-04-14 - Supports AppImage as an output format.

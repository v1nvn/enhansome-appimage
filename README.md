...
* [AppImagePool](https://github.com/prateekmedia/appimagepool) ⭐ 702 | 🐛 29 | 🌐 Dart | 📅 2024-07-28 - Simple, modern AppImageHub Client, powered by flutter.
...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,644 | 🐛 187 | 🌐 C++ | 📅 2025-12-15 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,562 | 🐛 160 | 🌐 Python | 📅 2026-02-02 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,059 | 🐛 515 | 🌐 C | 📅 2026-02-17 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 278 | 🐛 0 | 🌐 Shell | 📅 2026-02-15 - AppImage Manager that works like APT or Pacman.
...
* [linuxdeployqt](https://github.com/probonopd/linuxdeployqt) ⭐ 2,417 | 🐛 214 | 🌐 C++ | 📅 2025-10-21 - Deploys dependencies into AppDirs and creates AppImages; for Qt and other compiled applications.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,454 | 🐛 105 | 🌐 TypeScript | 📅 2026-02-16 - Supports AppImage as an output format.

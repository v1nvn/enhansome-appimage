...
* [AppImagePool](https://github.com/prateekmedia/appimagepool) ⭐ 703 | 🐛 29 | 🌐 Dart | 📅 2024-07-28 - Simple, modern AppImageHub Client, powered by flutter.
...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,650 | 🐛 187 | 🌐 C++ | 📅 2025-12-15 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,565 | 🐛 158 | 🌐 Python | 📅 2026-02-18 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,105 | 🐛 131 | 🌐 Go | 📅 2025-12-13 - Optional daemon that integrates AppImages into the system (experimental).
...
* [AppImageUpdate](https://github.com/AppImage/AppImageUpdate) ⭐ 690 | 🐛 77 | 🌐 C++ | 📅 2025-10-18 - Official grapical application to update AppImages; command-line tool to update AppImages.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,064 | 🐛 515 | 🌐 C | 📅 2026-02-18 - Optional sandbox with support for AppImage built in.
...
* [bauh](https://github.com/vinifmor/bauh) ⭐ 1,346 | 🐛 102 | 🌐 Python | 📅 2024-10-13 - Graphical user interface for managing Linux applications supporting AppImage, Arch (repositories/AUR), Flatpak, Snap and native Web applications.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 279 | 🐛 0 | 🌐 Shell | 📅 2026-02-15 - AppImage Manager that works like APT or Pacman.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,265 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Converts AppDirs into AppImages.
...
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 33 | 🐛 13 | 🌐 Starlark | 📅 2026-02-18 - Bazel rules to package any lang\_binary target as AppImage.
...
* [linuxdeployqt](https://github.com/probonopd/linuxdeployqt) ⭐ 2,418 | 🐛 214 | 🌐 C++ | 📅 2025-10-21 - Deploys dependencies into AppDirs and creates AppImages; for Qt and other compiled applications.
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,105 | 🐛 131 | 🌐 Go | 📅 2025-12-13 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 730 | 🐛 98 | 🌐 C++ | 📅 2025-11-07 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,453 | 🐛 108 | 🌐 TypeScript | 📅 2026-02-19 - Supports AppImage as an output format.
* [Appnativefy](https://github.com/sarweshparajuli/appnativefy) ⭐ 155 | 🐛 18 | 🌐 JavaScript | 📅 2023-02-03 - Create AppImage with embedded Electron browser from any website.
...
* [PupNet Deploy](https://github.com/kuiperzone/PupNet-Deploy) ⭐ 248 | 🐛 19 | 🌐 C# | 📅 2025-11-05 - Cross-platform deployment utility which publishes your .NET project and packages it as a ready-to-ship installation file in a single step.
...
* [pkg2appimage](https://github.com/AppImage/pkg2appimage) ⭐ 762 | 🐛 180 | 🌐 Shell | 📅 2025-07-21 - Converts from deb, zip, tar.gz and other formats to AppImage using YAML recipes.
...
* [appimage.yml](https://github.com/iotang/Project_LemonLime/blob/master/.github/workflows/appimage.yml) ⭐ 677 | 🐛 74 | 🌐 C++ | 📅 2026-02-10 - Bigger, more complex example of how to build and upload AppImages using GitHub Actions.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,265 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,265 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Comparison to other packaging systems.

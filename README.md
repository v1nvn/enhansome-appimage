...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,911 | 🐛 195 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,789 | 🐛 170 | 🌐 Python | 📅 2026-04-19 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,130 | 🐛 133 | 🌐 Go | 📅 2026-03-30 - Optional daemon that integrates AppImages into the system (experimental).
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,317 | 🐛 535 | 🌐 C | 📅 2026-04-23 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 302 | 🐛 0 | 🌐 Shell | 📅 2026-04-19 - AppImage Manager that works like APT or Pacman.
...
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 34 | 🐛 16 | 🌐 Starlark | 📅 2026-04-22 - Bazel rules to package any lang\_binary target as AppImage.
...
* [linuxdeployqt](https://github.com/probonopd/linuxdeployqt) ⭐ 2,445 | 🐛 213 | 🌐 C++ | 📅 2025-10-21 - Deploys dependencies into AppDirs and creates AppImages; for Qt and other compiled applications.
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,130 | 🐛 133 | 🌐 Go | 📅 2026-03-30 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 764 | 🐛 100 | 🌐 C++ | 📅 2026-04-21 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,530 | 🐛 103 | 🌐 TypeScript | 📅 2026-04-22 - Supports AppImage as an output format.

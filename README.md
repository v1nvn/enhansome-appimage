...
* [AppImagePool](https://github.com/prateekmedia/appimagepool) ⭐ 701 | 🐛 29 | 🌐 Dart | 📅 2024-07-28 - Simple, modern AppImageHub Client, powered by flutter.
...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,590 | 🐛 186 | 🌐 C++ | 📅 2025-12-15 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,520 | 🐛 154 | 🌐 Python | 📅 2026-02-02 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,099 | 🐛 131 | 🌐 Go | 📅 2025-12-13 - Optional daemon that integrates AppImages into the system (experimental).
...
* [XApp Thumbnailers](https://github.com/linuxmint/xapp-thumbnailers) ⭐ 54 | 🐛 3 | 🌐 Python | 📅 2026-01-30 - Thumbnailers for GTK Desktop Environments, including one for the AppImage file format. Makes Gtk based file managers like Caja (MATE), Nautilus (GNOME), Nemo (Cinnamon), PCManFM (LXDE), and Thunar (Xfce) show application icons on AppImages.
...
* [AppImage Desktop Maker](https://github.com/Alexsussa/AIDM) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2023-06-24 - Creates menu entries for AppImages without the need for a daemon.
...
* [AppImageUpdate](https://github.com/AppImage/AppImageUpdate) ⭐ 686 | 🐛 77 | 🌐 C++ | 📅 2025-10-18 - Official grapical application to update AppImages; command-line tool to update AppImages.
...
* [appimage-update](https://github.com/AppImageCrafters/appimage-update) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2020-07-27 - AppImage Update implementation written in Go.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,014 | 🐛 507 | 🌐 C | 📅 2026-02-07 - Optional sandbox with support for AppImage built in.
* [AppImage Sandboxing Project](https://github.com/mgord9518/aisap) ⭐ 57 | 🐛 2 | 🌐 Zig | 📅 2024-12-02 - Golang library to help sandbox AppImages with bwrap.
...
* [bauh](https://github.com/vinifmor/bauh) ⭐ 1,340 | 🐛 102 | 🌐 Python | 📅 2024-10-13 - Graphical user interface for managing Linux applications supporting AppImage, Arch (repositories/AUR), Flatpak, Snap and native Web applications.
* [Zap](https://github.com/srevinsaju/zap) ⭐ 563 | 🐛 51 | 🌐 Go | 📅 2024-06-14 - AppImage package manager. Downloads the AppImage if it does not exist. If it already exists, updates it with AppImageUpdate. Integrates AppImage into the system.
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 263 | 🐛 0 | 🌐 Shell | 📅 2026-02-01 - AppImage Manager that works like APT or Pacman.
* [appimage-manager](https://github.com/AppImageCrafters/appimage-manager) ⭐ 116 | 🐛 8 | 🌐 Go | 📅 2023-10-24 - Command-line tool for managing AppImages allowing to search, install, remove and update applications.
* [Bread](https://github.com/pegvin/bread) ⭐ 42 | 🐛 0 | 🌐 Go | 📅 2024-04-05 - Download, update, remove, and run AppImages from GitHub on the command line, and integrate apps into the desktop.
...
* [leap](https://github.com/lnxcz/leap) ⭐ 13 | 🐛 2 | 🌐 Rust | 📅 2024-01-19 - Fast and simple AppImage manager. Written in Rust.
* [homebrew-appimage](https://github.com/athrunsun/homebrew-appimage) ⭐ 10 | 🐛 0 | 🌐 Ruby | 📅 2022-02-05 - Linuxbrew AppImage Formulae.
...
* [Linux Mint](https://linuxmint.com/) - Has an [AppImage thumbnailer](https://github.com/linuxmint/xapp-thumbnailers) ⭐ 54 | 🐛 3 | 🌐 Python | 📅 2026-01-30 to show application icons on AppImage files.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,254 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Converts AppDirs into AppImages.
* [nix-bundle](https://github.com/matthewbauer/nix-bundle) ⭐ 807 | 🐛 56 | 🌐 Nix | 📅 2025-09-01 - Converts Nix derivations into AppImages.

### Build systems

* [appimage-builder](https://github.com/AppImageCrafters/appimage-builder) ⭐ 364 | 🐛 96 | 🌐 Python | 📅 2025-07-27 - Recipe based AppImage creation tool working from source.
* [appimagecraft](https://github.com/TheAssassin/appimagecraft) ⭐ 46 | 🐛 10 | 🌐 Python | 📅 2026-01-19 - Recipe based AppImage creation tool working from source.
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 32 | 🐛 13 | 🌐 Starlark | 📅 2026-02-05 - Bazel rules to package any lang\_binary target as AppImage.
* [AppImage.cmake](https://github.com/Ravbug/AppImage.cmake) ⭐ 25 | 🐛 0 | 🌐 CMake | 📅 2021-07-25 - CMake script which facilitates generating AppImage executables for Linux.
...
* [linuxdeployqt](https://github.com/probonopd/linuxdeployqt) ⭐ 2,414 | 🐛 214 | 🌐 C++ | 📅 2025-10-21 - Deploys dependencies into AppDirs and creates AppImages; for Qt and other compiled applications.
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,099 | 🐛 131 | 🌐 Go | 📅 2025-12-13 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 725 | 🐛 98 | 🌐 C++ | 📅 2025-11-07 - AppDir creation and maintenance tool using plugins.
...
* [python-appimage](https://github.com/niess/python-appimage) ⭐ 211 | 🐛 15 | 🌐 Python | 📅 2025-07-06 - Ready to use AppImage distributions of Python (can be modified to include your application).
...
* [linuxdeploy-plugin-python](https://github.com/niess/linuxdeploy-plugin-python) ⭐ 26 | 🐛 5 | 🌐 Shell | 📅 2024-05-23 - Bundle Python into an AppDir using a source distribution and linuxdeploy.
* [PyAppImage](https://github.com/srevinsaju/pyappimage) ⭐ 26 | 🐛 1 | 🌐 Python | 📅 2021-10-08 - Ultimately simple python-to-appimage bundler.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,440 | 🐛 119 | 🌐 TypeScript | 📅 2026-02-07 - Supports AppImage as an output format.
* [Appnativefy](https://github.com/sarweshparajuli/appnativefy) ⭐ 153 | 🐛 18 | 🌐 JavaScript | 📅 2023-02-03 - Create AppImage with embedded Electron browser from any website.
* [electron-forge-maker-appimage](https://github.com/saleae/electron-forge-maker-appimage) ⭐ 11 | 🐛 12 | 🌐 TypeScript | 📅 2023-11-18 - Electron Forge builder for AppImage.
...
* [nbPackager](https://github.com/trixon/nbPackager) ⭐ 10 | 🐛 1 | 🌐 Java | 📅 2026-01-31 - Packages NetBeans Platform Application with a JRE for AppImage, Linux, macOS and Windows.

### Deployment tools for .NET Core (Mono) applications

* [PupNet Deploy](https://github.com/kuiperzone/PupNet-Deploy) ⭐ 246 | 🐛 19 | 🌐 C# | 📅 2025-11-05 - Cross-platform deployment utility which publishes your .NET project and packages it as a ready-to-ship installation file in a single step.
* [DotnetPackaging](https://github.com/SuperJMN/DotnetPackaging) ⭐ 122 | 🐛 5 | 🌐 C# | 📅 2026-01-19 - Tool to distribute .NET applications in the AppImage format.
* [.NET Core AppImage example](https://github.com/ppy/osu-deploy/blob/697a49e9602502a2b7a899c0dff5383f6512d5d2/Program.cs#L207-L243) ⭐ 54 | 🐛 3 | 🌐 C# | 📅 2026-01-30 - Example of how to deploy .NET Core (Mono) applications as an AppImage using `dotnet publish -f netcoreapp3.1 -r linux-x64` from within a `.cs` program.
* [Publish-AppImage for .NET](https://github.com/kuiperzone/Publish-AppImage) ⭐ 35 | 🐛 1 | 🌐 Shell | 📅 2023-03-24 - Publish AppImages for .NET applications.
...
* [Cargo AppImage](https://github.com/StratusFearMe21/cargo-appimage) ⭐ 75 | 🐛 9 | 🌐 Rust | 📅 2025-08-09 - Cargo program that allows you to convert your Rust programs into AppImages.

### Tools to convert from other package formats

* [pkg2appimage](https://github.com/AppImage/pkg2appimage) ⭐ 761 | 🐛 179 | 🌐 Shell | 📅 2025-07-21 - Converts from deb, zip, tar.gz and other formats to AppImage using YAML recipes.
...
* [make-portable](https://github.com/sudo-give-me-coffee/make-portable) ⭐ 39 | 🐛 3 | 🌐 C | 📅 2025-02-10 - Deploys installed application to AppDir, uses strace to fetch all file system calls and copies all accessed files in to AppDir including glibc.
* [AppImaGen](https://github.com/ivan-hc/AppImaGen) ⭐ 33 | 🐛 0 | 🌐 Shell | 📅 2025-07-15 - Generates an AppImage from Debian or from a PPA of your choice for the previous (unfortunately not the oldest as recommended) and still supported Ubuntu LTS.
* [flatpak2appdir](https://github.com/sudo-give-me-coffee/flatpak2appdir) ⭐ 29 | 🐛 7 | 🌐 Shell | 📅 2020-05-11 - Turn Flatpak into AppDir which in turn can be turned into AppImage.
* [appimage-bash](https://github.com/valicm/appimage-bash) ⭐ 13 | 🐛 2 | 🌐 Shell | 📅 2025-01-16 - GitHub Action for creating AppImage releases from binaries inside `.tar.gz` archives.
...
* [Package-to-appimage](https://github.com/CausaPrincipalis71/package-to-appimage) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2022-11-02 - Tool for converting `.deb` and `.rpm` packages into AppImage format by using Docker.
* [GMAppImager](https://github.com/samuelvenable/GMAppImager) ⭐ 1 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-06-27 - Graphically Converts GameMaker Studio 2 games to AppImage bundles.
...
* [appimagelint](https://github.com/TheAssassin/appimagelint) ⭐ 55 | 🐛 16 | 🌐 Python | 📅 2025-12-15 - Tool to check AppImages for compatibility, best practices etc.
...
* [appimage.yml](https://github.com/iotang/Project_LemonLime/blob/master/.github/workflows/appimage.yml) ⭐ 674 | 🐛 75 | 🌐 C++ | 📅 2026-01-29 - Bigger, more complex example of how to build and upload AppImages using GitHub Actions.
* [GitHub Actions example](https://github.com/probonopd/Zoom.AppImage/blob/master/.github/workflows/main.yml) ⭐ 53 | 🐛 5 | 📅 2025-01-07 - Example of how to upload AppImages built using GitHub Actions to GitHub Releases.
...
* [libappimage](https://github.com/AppImage/libappimage) ⭐ 53 | 🐛 58 | 🌐 C++ | 📅 2025-10-31 - Implements functionality for dealing with AppImage files, written in C++ using Boost.
...
* [qt-qml-project-template-with-ci](https://github.com/219-design/qt-qml-project-template-with-ci) ⭐ 63 | 🐛 1 | 🌐 QML | 📅 2026-01-27 - Template for a Qt/QML application with batteries included: GitHub CI, automated GUI testing, automatic code-format checks and more. Compiles for Linux (AppImage), Mac, and Android.
* [mini-qml](https://github.com/patrickelectric/mini-qml) ⭐ 47 | 🐛 4 | 🌐 QML | 📅 2020-08-08 - Minimal Qml application template with deployment for Linux (AppImage), Windows, macOS and WebAssembly.
* [Briefcase Linux AppImage Template](https://github.com/beeware/briefcase-linux-appimage-template) ⭐ 21 | 🐛 1 | 🌐 Dockerfile | 📅 2026-01-30 - Cookiecutter template for building Python apps that will run under Linux, packaged as an AppImage.
...
* [AppImageSpec](https://github.com/AppImage/AppImageSpec) ⭐ 83 | 🐛 28 | 📅 2026-01-27 - Official specification for the AppImage format.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,254 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Official AppImage wiki.
* [appdwarf](https://github.com/Phantop/appdwarf) ⭐ 30 | 🐛 0 | 🌐 Shell | 📅 2025-08-08 - A tool to convert an AppDir or an existing AppImage file, either as a local file or from a URL, into a highly compressed portable image using dwarfs.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,254 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Comparison to other packaging systems.

### Other awesome lists

* [awesome-linuxdeploy](https://github.com/linuxdeploy/awesome-linuxdeploy) ⭐ 54 | 🐛 0 | 📅 2024-10-22 - Awesome list on linuxdeploy.

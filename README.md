...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,934 | 🐛 195 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,808 | 🐛 175 | 🌐 Python | 📅 2026-04-19 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,133 | 🐛 133 | 🌐 Go | 📅 2026-03-30 - Optional daemon that integrates AppImages into the system (experimental).
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,330 | 🐛 538 | 🌐 C | 📅 2026-04-27 - Optional sandbox with support for AppImage built in.
...
* [bauh](https://github.com/vinifmor/bauh) ⭐ 1,366 | 🐛 104 | 🌐 Python | 📅 2024-10-13 - Graphical user interface for managing Linux applications supporting AppImage, Arch (repositories/AUR), Flatpak, Snap and native Web applications.
* [Zap](https://github.com/srevinsaju/zap) ⭐ 577 | 🐛 51 | 🌐 Go | 📅 2024-06-14 - AppImage package manager. Downloads the AppImage if it does not exist. If it already exists, updates it with AppImageUpdate. Integrates AppImage into the system.
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 302 | 🐛 0 | 🌐 Shell | 📅 2026-04-26 - AppImage Manager that works like APT or Pacman.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,313 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Converts AppDirs into AppImages.
...
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 34 | 🐛 18 | 🌐 Starlark | 📅 2026-04-27 - Bazel rules to package any lang\_binary target as AppImage.
...
* [linuxdeployqt](https://github.com/probonopd/linuxdeployqt) ⭐ 2,448 | 🐛 213 | 🌐 C++ | 📅 2025-10-21 - Deploys dependencies into AppDirs and creates AppImages; for Qt and other compiled applications.
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,133 | 🐛 133 | 🌐 Go | 📅 2026-03-30 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 765 | 🐛 99 | 🌐 C++ | 📅 2026-04-27 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,537 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-28 - Supports AppImage as an output format.
...
* [pkg2appimage](https://github.com/AppImage/pkg2appimage) ⭐ 772 | 🐛 181 | 🌐 Shell | 📅 2025-07-21 - Converts from deb, zip, tar.gz and other formats to AppImage using YAML recipes.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,313 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,313 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Comparison to other packaging systems.

...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,821 | 🐛 193 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,694 | 🐛 163 | 🌐 Python | 📅 2026-04-01 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,123 | 🐛 133 | 🌐 Go | 📅 2026-03-30 - Optional daemon that integrates AppImages into the system (experimental).
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,238 | 🐛 524 | 🌐 C | 📅 2026-04-01 - Optional sandbox with support for AppImage built in.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,299 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Converts AppDirs into AppImages.
* [nix-bundle](https://github.com/matthewbauer/nix-bundle) ⭐ 829 | 🐛 57 | 🌐 Nix | 📅 2025-09-01 - Converts Nix derivations into AppImages.
...
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,123 | 🐛 133 | 🌐 Go | 📅 2026-03-30 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 751 | 🐛 99 | 🌐 C++ | 📅 2025-11-07 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,506 | 🐛 141 | 🌐 TypeScript | 📅 2026-04-01 - Supports AppImage as an output format.
...
* [AppImageSpec](https://github.com/AppImage/AppImageSpec) ⭐ 85 | 🐛 31 | 📅 2026-01-27 - Official specification for the AppImage format.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,299 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,299 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Comparison to other packaging systems.

...
* [AppImagePool](https://github.com/prateekmedia/appimagepool) ⭐ 705 | 🐛 28 | 🌐 Dart | 📅 2026-03-12 - Simple, modern AppImageHub Client, powered by flutter.
...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 7,743 | 🐛 189 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 1,643 | 🐛 161 | 🌐 Python | 📅 2026-03-03 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,117 | 🐛 132 | 🌐 Go | 📅 2025-12-13 - Optional daemon that integrates AppImages into the system (experimental).
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,166 | 🐛 518 | 🌐 C | 📅 2026-03-12 - Optional sandbox with support for AppImage built in.
...
* [bauh](https://github.com/vinifmor/bauh) ⭐ 1,348 | 🐛 102 | 🌐 Python | 📅 2024-10-13 - Graphical user interface for managing Linux applications supporting AppImage, Arch (repositories/AUR), Flatpak, Snap and native Web applications.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 292 | 🐛 0 | 🌐 Shell | 📅 2026-03-13 - AppImage Manager that works like APT or Pacman.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,281 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Converts AppDirs into AppImages.
* [nix-bundle](https://github.com/matthewbauer/nix-bundle) ⭐ 819 | 🐛 57 | 🌐 Nix | 📅 2025-09-01 - Converts Nix derivations into AppImages.
...
* [appimagecraft](https://github.com/TheAssassin/appimagecraft) ⭐ 47 | 🐛 12 | 🌐 Python | 📅 2026-03-12 - Recipe based AppImage creation tool working from source.
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 34 | 🐛 13 | 🌐 Starlark | 📅 2026-03-13 - Bazel rules to package any lang\_binary target as AppImage.
...
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,117 | 🐛 132 | 🌐 Go | 📅 2025-12-13 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,473 | 🐛 124 | 🌐 TypeScript | 📅 2026-03-12 - Supports AppImage as an output format.
...
* [pkg2appimage](https://github.com/AppImage/pkg2appimage) ⭐ 766 | 🐛 181 | 🌐 Shell | 📅 2025-07-21 - Converts from deb, zip, tar.gz and other formats to AppImage using YAML recipes.
...
* [appimage.yml](https://github.com/iotang/Project_LemonLime/blob/master/.github/workflows/appimage.yml) ⭐ 679 | 🐛 75 | 🌐 C++ | 📅 2026-03-07 - Bigger, more complex example of how to build and upload AppImages using GitHub Actions.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,281 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,281 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Comparison to other packaging systems.
